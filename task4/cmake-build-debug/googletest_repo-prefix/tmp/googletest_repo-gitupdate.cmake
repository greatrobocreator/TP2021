    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/anton/Documents/Education/TP2021/task4/cmake-build-debug/googletest_repo-prefix/src/googletest_repo'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/anton/Documents/Education/TP2021/task4/cmake-build-debug/googletest_repo-prefix/src/googletest_repo'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
